...
public class SendEmail {
	...
	public void sendMail(String user1, String userEmail) throws Exception {
		
		int sno = 1;
		List<CartProduct> cartItems = shoppingCartUtil.getCartItems(user1);	
		User user = userDataUtil.getUser(user1);
		...
		try {
			...
			String msg = "<!DOCTYPE html>"
					...
					+ "<br><br>"
					+ "<h2>" + user.getFirst_name() + " " + user.getLast_name() + " Cart Purchases</h2>"
					+ "<br><br>"
					+ cartHtml
					+ "</body>"
					+ "</html>";
