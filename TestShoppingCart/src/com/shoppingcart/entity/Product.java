...
public class Product {
	 ...
	 * @param product_price
	 */
	public Product(int product_id, String product_name, String product_description, double product_price, byte[] imgData) {
		super();
	...
	public String toString() {
		return "Product [product_id=" + product_id + ", product_name=" + product_name + ", product_description="
				+ product_description + ", product_price=" + product_price + ", imgData=" + Arrays.toString(imgData)
				+ "]";
	}
